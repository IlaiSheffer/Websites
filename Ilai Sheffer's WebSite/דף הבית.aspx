    ...
    <style>
        ...
        */
        ...
        .cards-container {
            ...
            gap: 20px;                
            margin-top: 20px;       /* מוסיף מרווח חיצוני של 20 פיקסלים מעל מיכל הכרטיסיות */  
        ...
        .card {
            width: 180px;             
            border: 2px solid #ccc;   /* מוסיף מסגרת בעובי 2 פיקסלים, רציפה, בצבע אפור בהיר */
            border-radius: 8px;       /* מעגל את הפינות של מסגרת הכרטיסייה למראה מודרני */
